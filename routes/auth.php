...
Route::middleware('guest')->group(function () {
    ...
    Route::get('register/verify-code', [RegisteredUserController::class, 'showVerifyForm'])
        ->name('register.verify-code');

    Route::post('register/verify-code', [RegisteredUserController::class, 'verifyEmail'])
